...
// checks if the CursorPageHosViolationRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageHosViolationRead{}

// CursorPageHosViolationRead struct for CursorPageHosViolationRead
type CursorPageHosViolationRead struct {
	Items                []HosViolationRead `json:"items"`
...
type _CursorPageHosViolationRead CursorPageHosViolationRead
...
func NewCursorPageHosViolationRead(items []HosViolationRead, total int32) *CursorPageHosViolationRead {
	this := CursorPageHosViolationRead{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageHosViolationRead) SetCurrentPageNil() {
...
func (o *CursorPageHosViolationRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageHosViolationRead) SetPreviousPageNil() {
...
func (o *CursorPageHosViolationRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageHosViolationRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageHosViolationRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageHosViolationRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageHosViolationRead := _CursorPageHosViolationRead{}

	err = json.Unmarshal(data, &varCursorPageHosViolationRead)

	if err != nil {
		return err
	}

	*o = CursorPageHosViolationRead(varCursorPageHosViolationRead)
...
type NullableCursorPageHosViolationRead struct {
	value *CursorPageHosViolationRead
	isSet bool
}

func (v NullableCursorPageHosViolationRead) Get() *CursorPageHosViolationRead {
	return v.value
}

func (v *NullableCursorPageHosViolationRead) Set(val *CursorPageHosViolationRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageHosViolationRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageHosViolationRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageHosViolationRead(val *CursorPageHosViolationRead) *NullableCursorPageHosViolationRead {
	return &NullableCursorPageHosViolationRead{value: val, isSet: true}
}

func (v NullableCursorPageHosViolationRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageHosViolationRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
