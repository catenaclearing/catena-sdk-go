...
// checks if the CursorPageRefHosRegion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageRefHosRegion{}

// CursorPageRefHosRegion struct for CursorPageRefHosRegion
type CursorPageRefHosRegion struct {
...
type _CursorPageRefHosRegion CursorPageRefHosRegion
...
func (o *CursorPageRefHosRegion) SetCurrentPageNil() {
...
func (o *CursorPageRefHosRegion) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageRefHosRegion) SetPreviousPageNil() {
...
func (o *CursorPageRefHosRegion) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageRefHosRegion) MarshalJSON() ([]byte, error) {
...
func (o CursorPageRefHosRegion) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageRefHosRegion) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageRefHosRegion := _CursorPageRefHosRegion{}

	err = json.Unmarshal(data, &varCursorPageRefHosRegion)

	if err != nil {
		return err
	}

	*o = CursorPageRefHosRegion(varCursorPageRefHosRegion)
...
type NullableCursorPageRefHosRegion struct {
	value *CursorPageRefHosRegion
	isSet bool
}

func (v NullableCursorPageRefHosRegion) Get() *CursorPageRefHosRegion {
	return v.value
}

func (v *NullableCursorPageRefHosRegion) Set(val *CursorPageRefHosRegion) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageRefHosRegion) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageRefHosRegion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageRefHosRegion(val *CursorPageRefHosRegion) *NullableCursorPageRefHosRegion {
	return &NullableCursorPageRefHosRegion{value: val, isSet: true}
}

func (v NullableCursorPageRefHosRegion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageRefHosRegion) UnmarshalJSON(src []byte) error {
	v.isSet = true
