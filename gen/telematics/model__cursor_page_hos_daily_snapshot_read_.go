...
// checks if the CursorPageHosDailySnapshotRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageHosDailySnapshotRead{}

// CursorPageHosDailySnapshotRead struct for CursorPageHosDailySnapshotRead
type CursorPageHosDailySnapshotRead struct {
	Items                []HosDailySnapshotRead `json:"items"`
...
type _CursorPageHosDailySnapshotRead CursorPageHosDailySnapshotRead
...
func NewCursorPageHosDailySnapshotRead(items []HosDailySnapshotRead, total int32) *CursorPageHosDailySnapshotRead {
	this := CursorPageHosDailySnapshotRead{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageHosDailySnapshotRead) SetCurrentPageNil() {
...
func (o *CursorPageHosDailySnapshotRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageHosDailySnapshotRead) SetPreviousPageNil() {
...
func (o *CursorPageHosDailySnapshotRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageHosDailySnapshotRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageHosDailySnapshotRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageHosDailySnapshotRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageHosDailySnapshotRead := _CursorPageHosDailySnapshotRead{}

	err = json.Unmarshal(data, &varCursorPageHosDailySnapshotRead)

	if err != nil {
		return err
	}

	*o = CursorPageHosDailySnapshotRead(varCursorPageHosDailySnapshotRead)
...
type NullableCursorPageHosDailySnapshotRead struct {
	value *CursorPageHosDailySnapshotRead
	isSet bool
}

func (v NullableCursorPageHosDailySnapshotRead) Get() *CursorPageHosDailySnapshotRead {
	return v.value
}

func (v *NullableCursorPageHosDailySnapshotRead) Set(val *CursorPageHosDailySnapshotRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageHosDailySnapshotRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageHosDailySnapshotRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageHosDailySnapshotRead(val *CursorPageHosDailySnapshotRead) *NullableCursorPageHosDailySnapshotRead {
	return &NullableCursorPageHosDailySnapshotRead{value: val, isSet: true}
}

func (v NullableCursorPageHosDailySnapshotRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageHosDailySnapshotRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
