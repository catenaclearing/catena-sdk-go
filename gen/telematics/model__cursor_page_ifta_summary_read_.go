...
// checks if the CursorPageIftaSummaryRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageIftaSummaryRead{}

// CursorPageIftaSummaryRead struct for CursorPageIftaSummaryRead
type CursorPageIftaSummaryRead struct {
	Items                []IftaSummaryRead `json:"items"`
...
type _CursorPageIftaSummaryRead CursorPageIftaSummaryRead
...
func NewCursorPageIftaSummaryRead(items []IftaSummaryRead, total int32) *CursorPageIftaSummaryRead {
	this := CursorPageIftaSummaryRead{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageIftaSummaryRead) SetCurrentPageNil() {
...
func (o *CursorPageIftaSummaryRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageIftaSummaryRead) SetPreviousPageNil() {
...
func (o *CursorPageIftaSummaryRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageIftaSummaryRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageIftaSummaryRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageIftaSummaryRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageIftaSummaryRead := _CursorPageIftaSummaryRead{}

	err = json.Unmarshal(data, &varCursorPageIftaSummaryRead)

	if err != nil {
		return err
	}

	*o = CursorPageIftaSummaryRead(varCursorPageIftaSummaryRead)
...
type NullableCursorPageIftaSummaryRead struct {
	value *CursorPageIftaSummaryRead
	isSet bool
}

func (v NullableCursorPageIftaSummaryRead) Get() *CursorPageIftaSummaryRead {
	return v.value
}

func (v *NullableCursorPageIftaSummaryRead) Set(val *CursorPageIftaSummaryRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageIftaSummaryRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageIftaSummaryRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageIftaSummaryRead(val *CursorPageIftaSummaryRead) *NullableCursorPageIftaSummaryRead {
	return &NullableCursorPageIftaSummaryRead{value: val, isSet: true}
}

func (v NullableCursorPageIftaSummaryRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageIftaSummaryRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
