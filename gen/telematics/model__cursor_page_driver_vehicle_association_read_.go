...
// checks if the CursorPageDriverVehicleAssociationRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageDriverVehicleAssociationRead{}

// CursorPageDriverVehicleAssociationRead struct for CursorPageDriverVehicleAssociationRead
type CursorPageDriverVehicleAssociationRead struct {
	Items                []DriverVehicleAssociationRead `json:"items"`
...
type _CursorPageDriverVehicleAssociationRead CursorPageDriverVehicleAssociationRead
...
func NewCursorPageDriverVehicleAssociationRead(items []DriverVehicleAssociationRead, total int32) *CursorPageDriverVehicleAssociationRead {
	this := CursorPageDriverVehicleAssociationRead{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageDriverVehicleAssociationRead) GetItems() []DriverVehicleAssociationRead {
	if o == nil {
		var ret []DriverVehicleAssociationRead
		return ret
	}
...
func (o *CursorPageDriverVehicleAssociationRead) SetCurrentPageNil() {
...
func (o *CursorPageDriverVehicleAssociationRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageDriverVehicleAssociationRead) SetPreviousPageNil() {
...
func (o *CursorPageDriverVehicleAssociationRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageDriverVehicleAssociationRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageDriverVehicleAssociationRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageDriverVehicleAssociationRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageDriverVehicleAssociationRead := _CursorPageDriverVehicleAssociationRead{}

	err = json.Unmarshal(data, &varCursorPageDriverVehicleAssociationRead)

	if err != nil {
		return err
	}

	*o = CursorPageDriverVehicleAssociationRead(varCursorPageDriverVehicleAssociationRead)
...
type NullableCursorPageDriverVehicleAssociationRead struct {
	value *CursorPageDriverVehicleAssociationRead
	isSet bool
}

func (v NullableCursorPageDriverVehicleAssociationRead) Get() *CursorPageDriverVehicleAssociationRead {
	return v.value
}

func (v *NullableCursorPageDriverVehicleAssociationRead) Set(val *CursorPageDriverVehicleAssociationRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageDriverVehicleAssociationRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageDriverVehicleAssociationRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageDriverVehicleAssociationRead(val *CursorPageDriverVehicleAssociationRead) *NullableCursorPageDriverVehicleAssociationRead {
	return &NullableCursorPageDriverVehicleAssociationRead{value: val, isSet: true}
}

func (v NullableCursorPageDriverVehicleAssociationRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageDriverVehicleAssociationRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
