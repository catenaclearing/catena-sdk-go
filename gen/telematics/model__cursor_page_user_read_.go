...
// checks if the CursorPageUserRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageUserRead{}

// CursorPageUserRead struct for CursorPageUserRead
type CursorPageUserRead struct {
	Items                []UserRead     `json:"items"`
...
type _CursorPageUserRead CursorPageUserRead
...
func (o *CursorPageUserRead) SetCurrentPageNil() {
...
func (o *CursorPageUserRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageUserRead) SetPreviousPageNil() {
...
func (o *CursorPageUserRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageUserRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageUserRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageUserRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageUserRead := _CursorPageUserRead{}

	err = json.Unmarshal(data, &varCursorPageUserRead)

	if err != nil {
		return err
	}

	*o = CursorPageUserRead(varCursorPageUserRead)
...
type NullableCursorPageUserRead struct {
	value *CursorPageUserRead
	isSet bool
}

func (v NullableCursorPageUserRead) Get() *CursorPageUserRead {
	return v.value
}

func (v *NullableCursorPageUserRead) Set(val *CursorPageUserRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageUserRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageUserRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageUserRead(val *CursorPageUserRead) *NullableCursorPageUserRead {
	return &NullableCursorPageUserRead{value: val, isSet: true}
}

func (v NullableCursorPageUserRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageUserRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
