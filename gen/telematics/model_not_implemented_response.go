...
// checks if the NotImplementedResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotImplementedResponse{}
...
func NewNotImplementedResponse() *NotImplementedResponse {
	...
	var code int32 = 501
	this.Code = &code
	var message string = "Not Implemented"
...
func (o *NotImplementedResponse) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o NotImplementedResponse) MarshalJSON() ([]byte, error) {
...
func (o NotImplementedResponse) ToMap() (map[string]interface{}, error) {
...
type NullableNotImplementedResponse struct {
	value *NotImplementedResponse
	isSet bool
}

func (v NullableNotImplementedResponse) Get() *NotImplementedResponse {
	return v.value
}

func (v *NullableNotImplementedResponse) Set(val *NotImplementedResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNotImplementedResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNotImplementedResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotImplementedResponse(val *NotImplementedResponse) *NullableNotImplementedResponse {
	return &NullableNotImplementedResponse{value: val, isSet: true}
}

func (v NullableNotImplementedResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotImplementedResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
