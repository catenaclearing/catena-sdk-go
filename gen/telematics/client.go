...
// APIClient manages communication with the Telematics Data Service - REST API API v0.1.0
...
type APIClient struct {
	...
	ComplianceRegulationAPI ComplianceRegulationAPI

	DriversUsersAPI DriversUsersAPI
