...
`func NewVehicleLocation(type_ string, coordinates Coordinates, ) *VehicleLocation`
...
`func (o *VehicleLocation) GetBbox() Bbox`

GetBbox returns the Bbox field if non-nil, zero value otherwise.

### GetBboxOk

`func (o *VehicleLocation) GetBboxOk() (*Bbox, bool)`
...
`func (o *VehicleLocation) SetType(v string)`
...
`func (o *VehicleLocation) GetCoordinates() Coordinates`

GetCoordinates returns the Coordinates field if non-nil, zero value otherwise.

### GetCoordinatesOk

`func (o *VehicleLocation) GetCoordinatesOk() (*Coordinates, bool)`
...
`func (o *VehicleLocation) SetCoordinates(v Coordinates)`
