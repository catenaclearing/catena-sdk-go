...
`func (o *HosAvailabilityRead) SetTspIdNil(b bool)`
...
`func (o *HosAvailabilityRead) SetTspSlugNil(b bool)`
...
`func (o *HosAvailabilityRead) SetExtrasNil(b bool)`

 SetExtrasNil sets the value for Extras to be an explicit nil

### UnsetExtras
`func (o *HosAvailabilityRead) UnsetExtras()`
