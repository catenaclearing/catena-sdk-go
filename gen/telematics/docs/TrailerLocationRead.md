...
`func (o *TrailerLocationRead) SetTspIdNil(b bool)`
...
`func (o *TrailerLocationRead) SetTspSlugNil(b bool)`
...
`func (o *TrailerLocationRead) SetExtrasNil(b bool)`

 SetExtrasNil sets the value for Extras to be an explicit nil

### UnsetExtras
`func (o *TrailerLocationRead) UnsetExtras()`
