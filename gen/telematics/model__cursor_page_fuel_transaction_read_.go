...
// checks if the CursorPageFuelTransactionRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageFuelTransactionRead{}

// CursorPageFuelTransactionRead struct for CursorPageFuelTransactionRead
type CursorPageFuelTransactionRead struct {
	Items                []FuelTransactionRead `json:"items"`
...
type _CursorPageFuelTransactionRead CursorPageFuelTransactionRead
...
func NewCursorPageFuelTransactionRead(items []FuelTransactionRead, total int32) *CursorPageFuelTransactionRead {
	this := CursorPageFuelTransactionRead{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageFuelTransactionRead) SetCurrentPageNil() {
...
func (o *CursorPageFuelTransactionRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageFuelTransactionRead) SetPreviousPageNil() {
...
func (o *CursorPageFuelTransactionRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageFuelTransactionRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageFuelTransactionRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageFuelTransactionRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageFuelTransactionRead := _CursorPageFuelTransactionRead{}

	err = json.Unmarshal(data, &varCursorPageFuelTransactionRead)

	if err != nil {
		return err
	}

	*o = CursorPageFuelTransactionRead(varCursorPageFuelTransactionRead)
...
type NullableCursorPageFuelTransactionRead struct {
	value *CursorPageFuelTransactionRead
	isSet bool
}

func (v NullableCursorPageFuelTransactionRead) Get() *CursorPageFuelTransactionRead {
	return v.value
}

func (v *NullableCursorPageFuelTransactionRead) Set(val *CursorPageFuelTransactionRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageFuelTransactionRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageFuelTransactionRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageFuelTransactionRead(val *CursorPageFuelTransactionRead) *NullableCursorPageFuelTransactionRead {
	return &NullableCursorPageFuelTransactionRead{value: val, isSet: true}
}

func (v NullableCursorPageFuelTransactionRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageFuelTransactionRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
