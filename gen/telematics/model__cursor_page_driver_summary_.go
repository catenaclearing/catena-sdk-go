...
// checks if the CursorPageDriverSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageDriverSummary{}

// CursorPageDriverSummary struct for CursorPageDriverSummary
type CursorPageDriverSummary struct {
	Items                []DriverSummary `json:"items"`
...
type _CursorPageDriverSummary CursorPageDriverSummary
...
func (o *CursorPageDriverSummary) SetCurrentPageNil() {
...
func (o *CursorPageDriverSummary) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageDriverSummary) SetPreviousPageNil() {
...
func (o *CursorPageDriverSummary) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageDriverSummary) MarshalJSON() ([]byte, error) {
...
func (o CursorPageDriverSummary) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageDriverSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageDriverSummary := _CursorPageDriverSummary{}

	err = json.Unmarshal(data, &varCursorPageDriverSummary)

	if err != nil {
		return err
	}

	*o = CursorPageDriverSummary(varCursorPageDriverSummary)
...
type NullableCursorPageDriverSummary struct {
	value *CursorPageDriverSummary
	isSet bool
}

func (v NullableCursorPageDriverSummary) Get() *CursorPageDriverSummary {
	return v.value
}

func (v *NullableCursorPageDriverSummary) Set(val *CursorPageDriverSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageDriverSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageDriverSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageDriverSummary(val *CursorPageDriverSummary) *NullableCursorPageDriverSummary {
	return &NullableCursorPageDriverSummary{value: val, isSet: true}
}

func (v NullableCursorPageDriverSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageDriverSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
