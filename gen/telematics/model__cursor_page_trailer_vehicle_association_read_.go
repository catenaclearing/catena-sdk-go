...
// checks if the CursorPageTrailerVehicleAssociationRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageTrailerVehicleAssociationRead{}

// CursorPageTrailerVehicleAssociationRead struct for CursorPageTrailerVehicleAssociationRead
type CursorPageTrailerVehicleAssociationRead struct {
	Items                []TrailerVehicleAssociationRead `json:"items"`
...
type _CursorPageTrailerVehicleAssociationRead CursorPageTrailerVehicleAssociationRead
...
func NewCursorPageTrailerVehicleAssociationRead(items []TrailerVehicleAssociationRead, total int32) *CursorPageTrailerVehicleAssociationRead {
	this := CursorPageTrailerVehicleAssociationRead{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageTrailerVehicleAssociationRead) GetItems() []TrailerVehicleAssociationRead {
	if o == nil {
		var ret []TrailerVehicleAssociationRead
		return ret
	}
...
func (o *CursorPageTrailerVehicleAssociationRead) SetCurrentPageNil() {
...
func (o *CursorPageTrailerVehicleAssociationRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageTrailerVehicleAssociationRead) SetPreviousPageNil() {
...
func (o *CursorPageTrailerVehicleAssociationRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageTrailerVehicleAssociationRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageTrailerVehicleAssociationRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageTrailerVehicleAssociationRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageTrailerVehicleAssociationRead := _CursorPageTrailerVehicleAssociationRead{}

	err = json.Unmarshal(data, &varCursorPageTrailerVehicleAssociationRead)

	if err != nil {
		return err
	}

	*o = CursorPageTrailerVehicleAssociationRead(varCursorPageTrailerVehicleAssociationRead)
...
type NullableCursorPageTrailerVehicleAssociationRead struct {
	value *CursorPageTrailerVehicleAssociationRead
	isSet bool
}

func (v NullableCursorPageTrailerVehicleAssociationRead) Get() *CursorPageTrailerVehicleAssociationRead {
	return v.value
}

func (v *NullableCursorPageTrailerVehicleAssociationRead) Set(val *CursorPageTrailerVehicleAssociationRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageTrailerVehicleAssociationRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageTrailerVehicleAssociationRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageTrailerVehicleAssociationRead(val *CursorPageTrailerVehicleAssociationRead) *NullableCursorPageTrailerVehicleAssociationRead {
	return &NullableCursorPageTrailerVehicleAssociationRead{value: val, isSet: true}
}

func (v NullableCursorPageTrailerVehicleAssociationRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageTrailerVehicleAssociationRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
