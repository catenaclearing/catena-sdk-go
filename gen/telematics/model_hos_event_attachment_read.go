...
func (o *HosEventAttachmentRead) SetTspIdNil() {
	o.TspId.Set(nil)
}
...
func (o *HosEventAttachmentRead) SetTspSlugNil() {
	o.TspSlug.Set(nil)
}
...
func (o *HosEventAttachmentRead) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHosEventAttachmentRead)
	...
	*o = HosEventAttachmentRead(varHosEventAttachmentRead)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "last_edit_at")
		delete(additionalProperties, "uploaded_by")
