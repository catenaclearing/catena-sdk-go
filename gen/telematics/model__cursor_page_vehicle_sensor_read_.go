...
// checks if the CursorPageVehicleSensorRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageVehicleSensorRead{}

// CursorPageVehicleSensorRead struct for CursorPageVehicleSensorRead
type CursorPageVehicleSensorRead struct {
	Items                []VehicleSensorRead `json:"items"`
...
func NewCursorPageVehicleSensorRead(items []VehicleSensorRead, total int32) *CursorPageVehicleSensorRead {
	this := CursorPageVehicleSensorRead{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageVehicleSensorRead) SetCurrentPageNil() {
...
func (o *CursorPageVehicleSensorRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageVehicleSensorRead) SetPreviousPageNil() {
...
func (o *CursorPageVehicleSensorRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageVehicleSensorRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageVehicleSensorRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageVehicleSensorRead) UnmarshalJSON(data []byte) (err error) {
...
type NullableCursorPageVehicleSensorRead struct {
	value *CursorPageVehicleSensorRead
	isSet bool
}

func (v NullableCursorPageVehicleSensorRead) Get() *CursorPageVehicleSensorRead {
	return v.value
}

func (v *NullableCursorPageVehicleSensorRead) Set(val *CursorPageVehicleSensorRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageVehicleSensorRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageVehicleSensorRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageVehicleSensorRead(val *CursorPageVehicleSensorRead) *NullableCursorPageVehicleSensorRead {
	return &NullableCursorPageVehicleSensorRead{value: val, isSet: true}
}

func (v NullableCursorPageVehicleSensorRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageVehicleSensorRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
