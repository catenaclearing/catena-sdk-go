...
// checks if the Trailer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Trailer{}

// Trailer Trailer model representing trailers in the system
type Trailer struct {
...
func (o *Trailer) SetDeletedAtNil() {
	o.DeletedAt.Set(nil)
}
...
func (o *Trailer) SetOccurredAtNil() {
...
func (o *Trailer) SetExecutionIdNil() {
...
func (o *Trailer) SetScheduleIdNil() {
...
func (o *Trailer) SetTrailerNameNil() {
...
func (o *Trailer) SetModelTypeNil() {
	o.ModelType.Set(nil)
}
...
func (o *Trailer) SetModelYearNil() {
	o.ModelYear.Set(nil)
}
...
func (o *Trailer) SetLicensePlateRegionNil() {
...
func (o *Trailer) SetLicensePlateCountryNil() {
...
func (o *Trailer) SetStartedAtNil() {
	o.StartedAt.Set(nil)
}
...
func (o *Trailer) SetEldSerialNumberNil() {
...
func (o *Trailer) SetEldDeviceTypeNil() {
...
func (o *Trailer) SetEldProductIdNil() {
...
func (o *Trailer) SetTotalAxlesNil() {
...
func (o *Trailer) SetExternalIdNil() {
...
func (o *Trailer) SetTrailerLengthNil() {
...
func (o *Trailer) SetTrailerTypeNil() {
...
func (o *Trailer) SetSpeedUnitNil() {
	o.SpeedUnit.Set(nil)
}
...
func (o *Trailer) SetOdometerUnitNil() {
...
func (o *Trailer) SetFuelCapacityNil() {
...
func (o *Trailer) SetEngineTypeNil() {
...
func (o Trailer) MarshalJSON() ([]byte, error) {
...
func (o Trailer) ToMap() (map[string]interface{}, error) {
...
func (o *Trailer) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varTrailer)

	if err != nil {
		return err
	}

	*o = Trailer(varTrailer)

	return err
}

type NullableTrailer struct {
	value *Trailer
	isSet bool
}

func (v NullableTrailer) Get() *Trailer {
	return v.value
}

func (v *NullableTrailer) Set(val *Trailer) {
	v.value = val
	v.isSet = true
}

func (v NullableTrailer) IsSet() bool {
	return v.isSet
}

func (v *NullableTrailer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrailer(val *Trailer) *NullableTrailer {
	return &NullableTrailer{value: val, isSet: true}
}

func (v NullableTrailer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrailer) UnmarshalJSON(src []byte) error {
	v.isSet = true
