...
// checks if the CursorPageDriverSafetyEventRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageDriverSafetyEventRead{}

// CursorPageDriverSafetyEventRead struct for CursorPageDriverSafetyEventRead
type CursorPageDriverSafetyEventRead struct {
	Items                []DriverSafetyEventRead `json:"items"`
...
type _CursorPageDriverSafetyEventRead CursorPageDriverSafetyEventRead
...
func NewCursorPageDriverSafetyEventRead(items []DriverSafetyEventRead, total int32) *CursorPageDriverSafetyEventRead {
	this := CursorPageDriverSafetyEventRead{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageDriverSafetyEventRead) SetCurrentPageNil() {
...
func (o *CursorPageDriverSafetyEventRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageDriverSafetyEventRead) SetPreviousPageNil() {
...
func (o *CursorPageDriverSafetyEventRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageDriverSafetyEventRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageDriverSafetyEventRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageDriverSafetyEventRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageDriverSafetyEventRead := _CursorPageDriverSafetyEventRead{}

	err = json.Unmarshal(data, &varCursorPageDriverSafetyEventRead)

	if err != nil {
		return err
	}

	*o = CursorPageDriverSafetyEventRead(varCursorPageDriverSafetyEventRead)
...
type NullableCursorPageDriverSafetyEventRead struct {
	value *CursorPageDriverSafetyEventRead
	isSet bool
}

func (v NullableCursorPageDriverSafetyEventRead) Get() *CursorPageDriverSafetyEventRead {
	return v.value
}

func (v *NullableCursorPageDriverSafetyEventRead) Set(val *CursorPageDriverSafetyEventRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageDriverSafetyEventRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageDriverSafetyEventRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageDriverSafetyEventRead(val *CursorPageDriverSafetyEventRead) *NullableCursorPageDriverSafetyEventRead {
	return &NullableCursorPageDriverSafetyEventRead{value: val, isSet: true}
}

func (v NullableCursorPageDriverSafetyEventRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageDriverSafetyEventRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
