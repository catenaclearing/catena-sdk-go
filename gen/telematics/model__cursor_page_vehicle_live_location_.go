...
// checks if the CursorPageVehicleLiveLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageVehicleLiveLocation{}

// CursorPageVehicleLiveLocation struct for CursorPageVehicleLiveLocation
type CursorPageVehicleLiveLocation struct {
	Items                []VehicleLiveLocation `json:"items"`
...
type _CursorPageVehicleLiveLocation CursorPageVehicleLiveLocation
...
func NewCursorPageVehicleLiveLocation(items []VehicleLiveLocation, total int32) *CursorPageVehicleLiveLocation {
	this := CursorPageVehicleLiveLocation{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageVehicleLiveLocation) SetCurrentPageNil() {
...
func (o *CursorPageVehicleLiveLocation) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageVehicleLiveLocation) SetPreviousPageNil() {
...
func (o *CursorPageVehicleLiveLocation) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageVehicleLiveLocation) MarshalJSON() ([]byte, error) {
...
func (o CursorPageVehicleLiveLocation) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageVehicleLiveLocation) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageVehicleLiveLocation := _CursorPageVehicleLiveLocation{}

	err = json.Unmarshal(data, &varCursorPageVehicleLiveLocation)

	if err != nil {
		return err
	}

	*o = CursorPageVehicleLiveLocation(varCursorPageVehicleLiveLocation)
...
type NullableCursorPageVehicleLiveLocation struct {
	value *CursorPageVehicleLiveLocation
	isSet bool
}

func (v NullableCursorPageVehicleLiveLocation) Get() *CursorPageVehicleLiveLocation {
	return v.value
}

func (v *NullableCursorPageVehicleLiveLocation) Set(val *CursorPageVehicleLiveLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageVehicleLiveLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageVehicleLiveLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageVehicleLiveLocation(val *CursorPageVehicleLiveLocation) *NullableCursorPageVehicleLiveLocation {
	return &NullableCursorPageVehicleLiveLocation{value: val, isSet: true}
}

func (v NullableCursorPageVehicleLiveLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageVehicleLiveLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
