...
// checks if the CursorPageVehicleSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageVehicleSummary{}

// CursorPageVehicleSummary struct for CursorPageVehicleSummary
type CursorPageVehicleSummary struct {
	Items                []VehicleSummary `json:"items"`
...
type _CursorPageVehicleSummary CursorPageVehicleSummary
...
func (o *CursorPageVehicleSummary) SetCurrentPageNil() {
...
func (o *CursorPageVehicleSummary) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageVehicleSummary) SetPreviousPageNil() {
...
func (o *CursorPageVehicleSummary) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageVehicleSummary) MarshalJSON() ([]byte, error) {
...
func (o CursorPageVehicleSummary) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageVehicleSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageVehicleSummary := _CursorPageVehicleSummary{}

	err = json.Unmarshal(data, &varCursorPageVehicleSummary)

	if err != nil {
		return err
	}

	*o = CursorPageVehicleSummary(varCursorPageVehicleSummary)
...
type NullableCursorPageVehicleSummary struct {
	value *CursorPageVehicleSummary
	isSet bool
}

func (v NullableCursorPageVehicleSummary) Get() *CursorPageVehicleSummary {
	return v.value
}

func (v *NullableCursorPageVehicleSummary) Set(val *CursorPageVehicleSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageVehicleSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageVehicleSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageVehicleSummary(val *CursorPageVehicleSummary) *NullableCursorPageVehicleSummary {
	return &NullableCursorPageVehicleSummary{value: val, isSet: true}
}

func (v NullableCursorPageVehicleSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageVehicleSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
