...
// checks if the CursorPageGroupMessageRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageGroupMessageRead{}

// CursorPageGroupMessageRead struct for CursorPageGroupMessageRead
type CursorPageGroupMessageRead struct {
	Items                []GroupMessageRead `json:"items"`
...
type _CursorPageGroupMessageRead CursorPageGroupMessageRead
...
func NewCursorPageGroupMessageRead(items []GroupMessageRead, total int32) *CursorPageGroupMessageRead {
	this := CursorPageGroupMessageRead{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageGroupMessageRead) SetCurrentPageNil() {
...
func (o *CursorPageGroupMessageRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageGroupMessageRead) SetPreviousPageNil() {
...
func (o *CursorPageGroupMessageRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageGroupMessageRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageGroupMessageRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageGroupMessageRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageGroupMessageRead := _CursorPageGroupMessageRead{}

	err = json.Unmarshal(data, &varCursorPageGroupMessageRead)

	if err != nil {
		return err
	}

	*o = CursorPageGroupMessageRead(varCursorPageGroupMessageRead)
...
type NullableCursorPageGroupMessageRead struct {
	value *CursorPageGroupMessageRead
	isSet bool
}

func (v NullableCursorPageGroupMessageRead) Get() *CursorPageGroupMessageRead {
	return v.value
}

func (v *NullableCursorPageGroupMessageRead) Set(val *CursorPageGroupMessageRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageGroupMessageRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageGroupMessageRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageGroupMessageRead(val *CursorPageGroupMessageRead) *NullableCursorPageGroupMessageRead {
	return &NullableCursorPageGroupMessageRead{value: val, isSet: true}
}

func (v NullableCursorPageGroupMessageRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageGroupMessageRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
