...
// checks if the CursorPageFleetSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageFleetSummary{}

// CursorPageFleetSummary struct for CursorPageFleetSummary
type CursorPageFleetSummary struct {
	Items                []FleetSummary `json:"items"`
...
type _CursorPageFleetSummary CursorPageFleetSummary
...
func (o *CursorPageFleetSummary) SetCurrentPageNil() {
...
func (o *CursorPageFleetSummary) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageFleetSummary) SetPreviousPageNil() {
...
func (o *CursorPageFleetSummary) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageFleetSummary) MarshalJSON() ([]byte, error) {
...
func (o CursorPageFleetSummary) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageFleetSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageFleetSummary := _CursorPageFleetSummary{}

	err = json.Unmarshal(data, &varCursorPageFleetSummary)

	if err != nil {
		return err
	}

	*o = CursorPageFleetSummary(varCursorPageFleetSummary)
...
type NullableCursorPageFleetSummary struct {
	value *CursorPageFleetSummary
	isSet bool
}

func (v NullableCursorPageFleetSummary) Get() *CursorPageFleetSummary {
	return v.value
}

func (v *NullableCursorPageFleetSummary) Set(val *CursorPageFleetSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageFleetSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageFleetSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageFleetSummary(val *CursorPageFleetSummary) *NullableCursorPageFleetSummary {
	return &NullableCursorPageFleetSummary{value: val, isSet: true}
}

func (v NullableCursorPageFleetSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageFleetSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
