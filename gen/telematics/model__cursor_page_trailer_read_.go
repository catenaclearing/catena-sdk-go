...
// checks if the CursorPageTrailerRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageTrailerRead{}

// CursorPageTrailerRead struct for CursorPageTrailerRead
type CursorPageTrailerRead struct {
	Items                []TrailerRead  `json:"items"`
...
type _CursorPageTrailerRead CursorPageTrailerRead
...
func (o *CursorPageTrailerRead) SetCurrentPageNil() {
...
func (o *CursorPageTrailerRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageTrailerRead) SetPreviousPageNil() {
...
func (o *CursorPageTrailerRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageTrailerRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageTrailerRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageTrailerRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageTrailerRead := _CursorPageTrailerRead{}

	err = json.Unmarshal(data, &varCursorPageTrailerRead)

	if err != nil {
		return err
	}

	*o = CursorPageTrailerRead(varCursorPageTrailerRead)
...
type NullableCursorPageTrailerRead struct {
	value *CursorPageTrailerRead
	isSet bool
}

func (v NullableCursorPageTrailerRead) Get() *CursorPageTrailerRead {
	return v.value
}

func (v *NullableCursorPageTrailerRead) Set(val *CursorPageTrailerRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageTrailerRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageTrailerRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageTrailerRead(val *CursorPageTrailerRead) *NullableCursorPageTrailerRead {
	return &NullableCursorPageTrailerRead{value: val, isSet: true}
}

func (v NullableCursorPageTrailerRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageTrailerRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
