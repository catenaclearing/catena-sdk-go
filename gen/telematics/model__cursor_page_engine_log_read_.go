...
// checks if the CursorPageEngineLogRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageEngineLogRead{}

// CursorPageEngineLogRead struct for CursorPageEngineLogRead
type CursorPageEngineLogRead struct {
	Items                []EngineLogRead `json:"items"`
...
type _CursorPageEngineLogRead CursorPageEngineLogRead
...
func (o *CursorPageEngineLogRead) SetCurrentPageNil() {
...
func (o *CursorPageEngineLogRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageEngineLogRead) SetPreviousPageNil() {
...
func (o *CursorPageEngineLogRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageEngineLogRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageEngineLogRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageEngineLogRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageEngineLogRead := _CursorPageEngineLogRead{}

	err = json.Unmarshal(data, &varCursorPageEngineLogRead)

	if err != nil {
		return err
	}

	*o = CursorPageEngineLogRead(varCursorPageEngineLogRead)
...
type NullableCursorPageEngineLogRead struct {
	value *CursorPageEngineLogRead
	isSet bool
}

func (v NullableCursorPageEngineLogRead) Get() *CursorPageEngineLogRead {
	return v.value
}

func (v *NullableCursorPageEngineLogRead) Set(val *CursorPageEngineLogRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageEngineLogRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageEngineLogRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageEngineLogRead(val *CursorPageEngineLogRead) *NullableCursorPageEngineLogRead {
	return &NullableCursorPageEngineLogRead{value: val, isSet: true}
}

func (v NullableCursorPageEngineLogRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageEngineLogRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
