...
// checks if the CursorPageMessageRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageMessageRead{}

// CursorPageMessageRead struct for CursorPageMessageRead
type CursorPageMessageRead struct {
	Items                []MessageRead  `json:"items"`
...
type _CursorPageMessageRead CursorPageMessageRead
...
func (o *CursorPageMessageRead) SetCurrentPageNil() {
...
func (o *CursorPageMessageRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageMessageRead) SetPreviousPageNil() {
...
func (o *CursorPageMessageRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageMessageRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageMessageRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageMessageRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageMessageRead := _CursorPageMessageRead{}

	err = json.Unmarshal(data, &varCursorPageMessageRead)

	if err != nil {
		return err
	}

	*o = CursorPageMessageRead(varCursorPageMessageRead)
...
type NullableCursorPageMessageRead struct {
	value *CursorPageMessageRead
	isSet bool
}

func (v NullableCursorPageMessageRead) Get() *CursorPageMessageRead {
	return v.value
}

func (v *NullableCursorPageMessageRead) Set(val *CursorPageMessageRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageMessageRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageMessageRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageMessageRead(val *CursorPageMessageRead) *NullableCursorPageMessageRead {
	return &NullableCursorPageMessageRead{value: val, isSet: true}
}

func (v NullableCursorPageMessageRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageMessageRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
