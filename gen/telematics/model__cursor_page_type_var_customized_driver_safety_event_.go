...
// checks if the CursorPageTypeVarCustomizedDriverSafetyEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageTypeVarCustomizedDriverSafetyEvent{}

// CursorPageTypeVarCustomizedDriverSafetyEvent struct for CursorPageTypeVarCustomizedDriverSafetyEvent
type CursorPageTypeVarCustomizedDriverSafetyEvent struct {
	Items                []DriverSafetyEvent `json:"items"`
...
type _CursorPageTypeVarCustomizedDriverSafetyEvent CursorPageTypeVarCustomizedDriverSafetyEvent
...
func NewCursorPageTypeVarCustomizedDriverSafetyEvent(items []DriverSafetyEvent) *CursorPageTypeVarCustomizedDriverSafetyEvent {
	this := CursorPageTypeVarCustomizedDriverSafetyEvent{}
	this.Items = items
	return &this
}
...
func (o *CursorPageTypeVarCustomizedDriverSafetyEvent) SetCurrentPageNil() {
...
func (o *CursorPageTypeVarCustomizedDriverSafetyEvent) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageTypeVarCustomizedDriverSafetyEvent) SetPreviousPageNil() {
...
func (o *CursorPageTypeVarCustomizedDriverSafetyEvent) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageTypeVarCustomizedDriverSafetyEvent) MarshalJSON() ([]byte, error) {
...
func (o CursorPageTypeVarCustomizedDriverSafetyEvent) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageTypeVarCustomizedDriverSafetyEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageTypeVarCustomizedDriverSafetyEvent := _CursorPageTypeVarCustomizedDriverSafetyEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCursorPageTypeVarCustomizedDriverSafetyEvent)

	if err != nil {
		return err
	}

	*o = CursorPageTypeVarCustomizedDriverSafetyEvent(varCursorPageTypeVarCustomizedDriverSafetyEvent)

	return err
}

type NullableCursorPageTypeVarCustomizedDriverSafetyEvent struct {
	value *CursorPageTypeVarCustomizedDriverSafetyEvent
	isSet bool
}

func (v NullableCursorPageTypeVarCustomizedDriverSafetyEvent) Get() *CursorPageTypeVarCustomizedDriverSafetyEvent {
	return v.value
}

func (v *NullableCursorPageTypeVarCustomizedDriverSafetyEvent) Set(val *CursorPageTypeVarCustomizedDriverSafetyEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageTypeVarCustomizedDriverSafetyEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageTypeVarCustomizedDriverSafetyEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageTypeVarCustomizedDriverSafetyEvent(val *CursorPageTypeVarCustomizedDriverSafetyEvent) *NullableCursorPageTypeVarCustomizedDriverSafetyEvent {
	return &NullableCursorPageTypeVarCustomizedDriverSafetyEvent{value: val, isSet: true}
}

func (v NullableCursorPageTypeVarCustomizedDriverSafetyEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageTypeVarCustomizedDriverSafetyEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
