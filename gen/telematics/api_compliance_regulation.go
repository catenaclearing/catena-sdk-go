...
type ComplianceRegulationAPI interface {
	...
	*/
	...
	CreateDvirLogExecute(r ApiCreateDvirLogRequest) (*ResourceOperation, *http.Response, error)
...
func (r ApiCreateDvirLogRequest) IsSync(isSync bool) ApiCreateDvirLogRequest {
	r.isSync = &isSync
	return r
}

func (r ApiCreateDvirLogRequest) Execute() (*ResourceOperation, *http.Response, error) {
...
//
//	@return ResourceOperation
func (a *ComplianceRegulationAPIService) CreateDvirLogExecute(r ApiCreateDvirLogRequest) (*ResourceOperation, *http.Response, error) {
	var (
