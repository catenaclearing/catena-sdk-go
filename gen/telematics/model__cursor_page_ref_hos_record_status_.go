...
// checks if the CursorPageRefHosRecordStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageRefHosRecordStatus{}

// CursorPageRefHosRecordStatus struct for CursorPageRefHosRecordStatus
type CursorPageRefHosRecordStatus struct {
...
type _CursorPageRefHosRecordStatus CursorPageRefHosRecordStatus
...
func NewCursorPageRefHosRecordStatus(items []RefHosRecordStatus, total int32) *CursorPageRefHosRecordStatus {
	this := CursorPageRefHosRecordStatus{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageRefHosRecordStatus) SetCurrentPageNil() {
...
func (o *CursorPageRefHosRecordStatus) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageRefHosRecordStatus) SetPreviousPageNil() {
...
func (o *CursorPageRefHosRecordStatus) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageRefHosRecordStatus) MarshalJSON() ([]byte, error) {
...
func (o CursorPageRefHosRecordStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageRefHosRecordStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageRefHosRecordStatus := _CursorPageRefHosRecordStatus{}

	err = json.Unmarshal(data, &varCursorPageRefHosRecordStatus)

	if err != nil {
		return err
	}

	*o = CursorPageRefHosRecordStatus(varCursorPageRefHosRecordStatus)
...
type NullableCursorPageRefHosRecordStatus struct {
	value *CursorPageRefHosRecordStatus
	isSet bool
}

func (v NullableCursorPageRefHosRecordStatus) Get() *CursorPageRefHosRecordStatus {
	return v.value
}

func (v *NullableCursorPageRefHosRecordStatus) Set(val *CursorPageRefHosRecordStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageRefHosRecordStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageRefHosRecordStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageRefHosRecordStatus(val *CursorPageRefHosRecordStatus) *NullableCursorPageRefHosRecordStatus {
	return &NullableCursorPageRefHosRecordStatus{value: val, isSet: true}
}

func (v NullableCursorPageRefHosRecordStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageRefHosRecordStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
