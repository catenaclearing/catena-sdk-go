...
// checks if the CursorPageRefHosViolationCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageRefHosViolationCode{}

// CursorPageRefHosViolationCode struct for CursorPageRefHosViolationCode
type CursorPageRefHosViolationCode struct {
...
type _CursorPageRefHosViolationCode CursorPageRefHosViolationCode
...
func NewCursorPageRefHosViolationCode(items []RefHosViolationCode, total int32) *CursorPageRefHosViolationCode {
	this := CursorPageRefHosViolationCode{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageRefHosViolationCode) SetCurrentPageNil() {
...
func (o *CursorPageRefHosViolationCode) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageRefHosViolationCode) SetPreviousPageNil() {
...
func (o *CursorPageRefHosViolationCode) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageRefHosViolationCode) MarshalJSON() ([]byte, error) {
...
func (o CursorPageRefHosViolationCode) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageRefHosViolationCode) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageRefHosViolationCode := _CursorPageRefHosViolationCode{}

	err = json.Unmarshal(data, &varCursorPageRefHosViolationCode)

	if err != nil {
		return err
	}

	*o = CursorPageRefHosViolationCode(varCursorPageRefHosViolationCode)
...
type NullableCursorPageRefHosViolationCode struct {
	value *CursorPageRefHosViolationCode
	isSet bool
}

func (v NullableCursorPageRefHosViolationCode) Get() *CursorPageRefHosViolationCode {
	return v.value
}

func (v *NullableCursorPageRefHosViolationCode) Set(val *CursorPageRefHosViolationCode) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageRefHosViolationCode) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageRefHosViolationCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageRefHosViolationCode(val *CursorPageRefHosViolationCode) *NullableCursorPageRefHosViolationCode {
	return &NullableCursorPageRefHosViolationCode{value: val, isSet: true}
}

func (v NullableCursorPageRefHosViolationCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageRefHosViolationCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
