...
// checks if the CursorPageFleetRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageFleetRead{}

// CursorPageFleetRead struct for CursorPageFleetRead
type CursorPageFleetRead struct {
...
type _CursorPageFleetRead CursorPageFleetRead
...
func (o *CursorPageFleetRead) SetCurrentPageNil() {
...
func (o *CursorPageFleetRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageFleetRead) SetPreviousPageNil() {
...
func (o *CursorPageFleetRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageFleetRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageFleetRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageFleetRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageFleetRead := _CursorPageFleetRead{}

	err = json.Unmarshal(data, &varCursorPageFleetRead)

	if err != nil {
		return err
	}

	*o = CursorPageFleetRead(varCursorPageFleetRead)
...
type NullableCursorPageFleetRead struct {
	value *CursorPageFleetRead
	isSet bool
}

func (v NullableCursorPageFleetRead) Get() *CursorPageFleetRead {
	return v.value
}

func (v *NullableCursorPageFleetRead) Set(val *CursorPageFleetRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageFleetRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageFleetRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageFleetRead(val *CursorPageFleetRead) *NullableCursorPageFleetRead {
	return &NullableCursorPageFleetRead{value: val, isSet: true}
}

func (v NullableCursorPageFleetRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageFleetRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
