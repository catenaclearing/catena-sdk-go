...
// checks if the CursorPageInvitationRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageInvitationRead{}

// CursorPageInvitationRead struct for CursorPageInvitationRead
type CursorPageInvitationRead struct {
...
type _CursorPageInvitationRead CursorPageInvitationRead
...
func (o *CursorPageInvitationRead) SetCurrentPageNil() {
...
func (o *CursorPageInvitationRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageInvitationRead) SetPreviousPageNil() {
...
func (o *CursorPageInvitationRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageInvitationRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageInvitationRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageInvitationRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageInvitationRead := _CursorPageInvitationRead{}

	err = json.Unmarshal(data, &varCursorPageInvitationRead)

	if err != nil {
		return err
	}

	*o = CursorPageInvitationRead(varCursorPageInvitationRead)
...
type NullableCursorPageInvitationRead struct {
	value *CursorPageInvitationRead
	isSet bool
}

func (v NullableCursorPageInvitationRead) Get() *CursorPageInvitationRead {
	return v.value
}

func (v *NullableCursorPageInvitationRead) Set(val *CursorPageInvitationRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageInvitationRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageInvitationRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageInvitationRead(val *CursorPageInvitationRead) *NullableCursorPageInvitationRead {
	return &NullableCursorPageInvitationRead{value: val, isSet: true}
}

func (v NullableCursorPageInvitationRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageInvitationRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
