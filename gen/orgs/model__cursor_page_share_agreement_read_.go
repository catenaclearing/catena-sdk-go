...
// checks if the CursorPageShareAgreementRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageShareAgreementRead{}

// CursorPageShareAgreementRead struct for CursorPageShareAgreementRead
type CursorPageShareAgreementRead struct {
...
type _CursorPageShareAgreementRead CursorPageShareAgreementRead
...
func NewCursorPageShareAgreementRead(items []ShareAgreementRead, total int32) *CursorPageShareAgreementRead {
	this := CursorPageShareAgreementRead{}
	this.Items = items
	this.Total = total
	return &this
}
...
func (o *CursorPageShareAgreementRead) SetCurrentPageNil() {
...
func (o *CursorPageShareAgreementRead) SetCurrentPageBackwardsNil() {
...
func (o *CursorPageShareAgreementRead) SetPreviousPageNil() {
...
func (o *CursorPageShareAgreementRead) SetNextPageNil() {
	o.NextPage.Set(nil)
}
...
func (o CursorPageShareAgreementRead) MarshalJSON() ([]byte, error) {
...
func (o CursorPageShareAgreementRead) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageShareAgreementRead) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageShareAgreementRead := _CursorPageShareAgreementRead{}

	err = json.Unmarshal(data, &varCursorPageShareAgreementRead)

	if err != nil {
		return err
	}

	*o = CursorPageShareAgreementRead(varCursorPageShareAgreementRead)
...
type NullableCursorPageShareAgreementRead struct {
	value *CursorPageShareAgreementRead
	isSet bool
}

func (v NullableCursorPageShareAgreementRead) Get() *CursorPageShareAgreementRead {
	return v.value
}

func (v *NullableCursorPageShareAgreementRead) Set(val *CursorPageShareAgreementRead) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageShareAgreementRead) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageShareAgreementRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageShareAgreementRead(val *CursorPageShareAgreementRead) *NullableCursorPageShareAgreementRead {
	return &NullableCursorPageShareAgreementRead{value: val, isSet: true}
}

func (v NullableCursorPageShareAgreementRead) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageShareAgreementRead) UnmarshalJSON(src []byte) error {
	v.isSet = true
