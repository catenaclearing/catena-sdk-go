...
// checks if the EngineStatusAdded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EngineStatusAdded{}

// EngineStatusAdded Engine status added event.
type EngineStatusAdded struct {
...
type _EngineStatusAdded EngineStatusAdded
...
func NewEngineStatusAdded(version string, data []BaseEngineStatus, webhookId string) *EngineStatusAdded {
	this := EngineStatusAdded{}
	this.Version = version
	var eventName string = "engine_status.added"
...
func (o *EngineStatusAdded) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *EngineStatusAdded) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o EngineStatusAdded) MarshalJSON() ([]byte, error) {
...
func (o EngineStatusAdded) ToMap() (map[string]interface{}, error) {
...
func (o *EngineStatusAdded) UnmarshalJSON(data []byte) (err error) {
	...
	varEngineStatusAdded := _EngineStatusAdded{}

	err = json.Unmarshal(data, &varEngineStatusAdded)

	if err != nil {
		return err
	}

	*o = EngineStatusAdded(varEngineStatusAdded)
...
type NullableEngineStatusAdded struct {
	value *EngineStatusAdded
	isSet bool
}

func (v NullableEngineStatusAdded) Get() *EngineStatusAdded {
	return v.value
}

func (v *NullableEngineStatusAdded) Set(val *EngineStatusAdded) {
	v.value = val
	v.isSet = true
}

func (v NullableEngineStatusAdded) IsSet() bool {
	return v.isSet
}

func (v *NullableEngineStatusAdded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEngineStatusAdded(val *EngineStatusAdded) *NullableEngineStatusAdded {
	return &NullableEngineStatusAdded{value: val, isSet: true}
}

func (v NullableEngineStatusAdded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEngineStatusAdded) UnmarshalJSON(src []byte) error {
	v.isSet = true
