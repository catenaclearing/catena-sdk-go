...
// checks if the InvitationSent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvitationSent{}

// InvitationSent Invitation sent event.
...
type _InvitationSent InvitationSent
...
func NewInvitationSent(version string, data []BaseInvitationEvent, webhookId string) *InvitationSent {
	...
	var eventName string = "invitation.sent"
...
func (o *InvitationSent) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *InvitationSent) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o InvitationSent) MarshalJSON() ([]byte, error) {
...
func (o InvitationSent) ToMap() (map[string]interface{}, error) {
...
func (o *InvitationSent) UnmarshalJSON(data []byte) (err error) {
	...
	varInvitationSent := _InvitationSent{}

	err = json.Unmarshal(data, &varInvitationSent)

	if err != nil {
		return err
	}

	*o = InvitationSent(varInvitationSent)
...
type NullableInvitationSent struct {
	value *InvitationSent
	isSet bool
}

func (v NullableInvitationSent) Get() *InvitationSent {
	return v.value
}

func (v *NullableInvitationSent) Set(val *InvitationSent) {
	v.value = val
	v.isSet = true
}

func (v NullableInvitationSent) IsSet() bool {
	return v.isSet
}

func (v *NullableInvitationSent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvitationSent(val *InvitationSent) *NullableInvitationSent {
	return &NullableInvitationSent{value: val, isSet: true}
}

func (v NullableInvitationSent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvitationSent) UnmarshalJSON(src []byte) error {
	v.isSet = true
