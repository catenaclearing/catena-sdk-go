...
// checks if the EngineStatusModified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EngineStatusModified{}

// EngineStatusModified Engine status modified event.
type EngineStatusModified struct {
	...
	Data []BaseEngineStatus `json:"data"`
...
type _EngineStatusModified EngineStatusModified
...
func NewEngineStatusModified(version string, data []BaseEngineStatus, webhookId string) *EngineStatusModified {
	this := EngineStatusModified{}
	this.Version = version
	var eventName string = "engine_status.modified"
...
func (o *EngineStatusModified) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *EngineStatusModified) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o EngineStatusModified) MarshalJSON() ([]byte, error) {
...
func (o EngineStatusModified) ToMap() (map[string]interface{}, error) {
...
func (o *EngineStatusModified) UnmarshalJSON(data []byte) (err error) {
	...
	varEngineStatusModified := _EngineStatusModified{}

	err = json.Unmarshal(data, &varEngineStatusModified)

	if err != nil {
		return err
	}

	*o = EngineStatusModified(varEngineStatusModified)
...
type NullableEngineStatusModified struct {
	value *EngineStatusModified
	isSet bool
}

func (v NullableEngineStatusModified) Get() *EngineStatusModified {
	return v.value
}

func (v *NullableEngineStatusModified) Set(val *EngineStatusModified) {
	v.value = val
	v.isSet = true
}

func (v NullableEngineStatusModified) IsSet() bool {
	return v.isSet
}

func (v *NullableEngineStatusModified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEngineStatusModified(val *EngineStatusModified) *NullableEngineStatusModified {
	return &NullableEngineStatusModified{value: val, isSet: true}
}

func (v NullableEngineStatusModified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEngineStatusModified) UnmarshalJSON(src []byte) error {
	v.isSet = true
