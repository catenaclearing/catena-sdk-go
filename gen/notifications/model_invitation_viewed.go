...
// checks if the InvitationViewed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvitationViewed{}

// InvitationViewed Invitation viewed event.
type InvitationViewed struct {
...
type _InvitationViewed InvitationViewed
...
func NewInvitationViewed(version string, data []BaseInvitationEvent, webhookId string) *InvitationViewed {
	this := InvitationViewed{}
	this.Version = version
	var eventName string = "invitation.viewed"
...
func (o *InvitationViewed) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *InvitationViewed) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o InvitationViewed) MarshalJSON() ([]byte, error) {
...
func (o InvitationViewed) ToMap() (map[string]interface{}, error) {
...
func (o *InvitationViewed) UnmarshalJSON(data []byte) (err error) {
	...
	varInvitationViewed := _InvitationViewed{}

	err = json.Unmarshal(data, &varInvitationViewed)

	if err != nil {
		return err
	}

	*o = InvitationViewed(varInvitationViewed)
...
type NullableInvitationViewed struct {
	value *InvitationViewed
	isSet bool
}

func (v NullableInvitationViewed) Get() *InvitationViewed {
	return v.value
}

func (v *NullableInvitationViewed) Set(val *InvitationViewed) {
	v.value = val
	v.isSet = true
}

func (v NullableInvitationViewed) IsSet() bool {
	return v.isSet
}

func (v *NullableInvitationViewed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvitationViewed(val *InvitationViewed) *NullableInvitationViewed {
	return &NullableInvitationViewed{value: val, isSet: true}
}

func (v NullableInvitationViewed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvitationViewed) UnmarshalJSON(src []byte) error {
	v.isSet = true
