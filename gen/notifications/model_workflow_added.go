...
// checks if the WorkflowAdded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowAdded{}

// WorkflowAdded Workflow added event.
type WorkflowAdded struct {
...
type _WorkflowAdded WorkflowAdded
...
func NewWorkflowAdded(version string, data []BaseWorkflow, webhookId string) *WorkflowAdded {
	...
	var eventName string = "workflow.added"
...
func (o *WorkflowAdded) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o WorkflowAdded) MarshalJSON() ([]byte, error) {
...
func (o WorkflowAdded) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowAdded) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkflowAdded := _WorkflowAdded{}

	err = json.Unmarshal(data, &varWorkflowAdded)

	if err != nil {
		return err
	}

	*o = WorkflowAdded(varWorkflowAdded)
...
type NullableWorkflowAdded struct {
	value *WorkflowAdded
	isSet bool
}

func (v NullableWorkflowAdded) Get() *WorkflowAdded {
	return v.value
}

func (v *NullableWorkflowAdded) Set(val *WorkflowAdded) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowAdded) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowAdded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowAdded(val *WorkflowAdded) *NullableWorkflowAdded {
	return &NullableWorkflowAdded{value: val, isSet: true}
}

func (v NullableWorkflowAdded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowAdded) UnmarshalJSON(src []byte) error {
	v.isSet = true
