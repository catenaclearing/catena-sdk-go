...
// checks if the InvitationCreated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvitationCreated{}

// InvitationCreated Invitation created event.
...
type _InvitationCreated InvitationCreated
...
func NewInvitationCreated(version string, data []BaseInvitationEvent, webhookId string) *InvitationCreated {
	this := InvitationCreated{}
	this.Version = version
	var eventName string = "invitation.created"
...
func (o *InvitationCreated) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *InvitationCreated) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o InvitationCreated) MarshalJSON() ([]byte, error) {
...
func (o InvitationCreated) ToMap() (map[string]interface{}, error) {
...
func (o *InvitationCreated) UnmarshalJSON(data []byte) (err error) {
	...
	varInvitationCreated := _InvitationCreated{}

	err = json.Unmarshal(data, &varInvitationCreated)

	if err != nil {
		return err
	}

	*o = InvitationCreated(varInvitationCreated)
...
type NullableInvitationCreated struct {
	value *InvitationCreated
	isSet bool
}

func (v NullableInvitationCreated) Get() *InvitationCreated {
	return v.value
}

func (v *NullableInvitationCreated) Set(val *InvitationCreated) {
	v.value = val
	v.isSet = true
}

func (v NullableInvitationCreated) IsSet() bool {
	return v.isSet
}

func (v *NullableInvitationCreated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvitationCreated(val *InvitationCreated) *NullableInvitationCreated {
	return &NullableInvitationCreated{value: val, isSet: true}
}

func (v NullableInvitationCreated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvitationCreated) UnmarshalJSON(src []byte) error {
	v.isSet = true
