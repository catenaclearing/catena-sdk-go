...
// checks if the DvirLogModified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvirLogModified{}

// DvirLogModified DVIR log modified event.
type DvirLogModified struct {
...
type _DvirLogModified DvirLogModified
...
func NewDvirLogModified(version string, data []BaseDvirLog, webhookId string) *DvirLogModified {
	this := DvirLogModified{}
	this.Version = version
	var eventName string = "dvir_log.modified"
...
func (o *DvirLogModified) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *DvirLogModified) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o DvirLogModified) MarshalJSON() ([]byte, error) {
...
func (o DvirLogModified) ToMap() (map[string]interface{}, error) {
...
func (o *DvirLogModified) UnmarshalJSON(data []byte) (err error) {
	...
	varDvirLogModified := _DvirLogModified{}

	err = json.Unmarshal(data, &varDvirLogModified)

	if err != nil {
		return err
	}

	*o = DvirLogModified(varDvirLogModified)
...
type NullableDvirLogModified struct {
	value *DvirLogModified
	isSet bool
}

func (v NullableDvirLogModified) Get() *DvirLogModified {
	return v.value
}

func (v *NullableDvirLogModified) Set(val *DvirLogModified) {
	v.value = val
	v.isSet = true
}

func (v NullableDvirLogModified) IsSet() bool {
	return v.isSet
}

func (v *NullableDvirLogModified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvirLogModified(val *DvirLogModified) *NullableDvirLogModified {
	return &NullableDvirLogModified{value: val, isSet: true}
}

func (v NullableDvirLogModified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvirLogModified) UnmarshalJSON(src []byte) error {
	v.isSet = true
