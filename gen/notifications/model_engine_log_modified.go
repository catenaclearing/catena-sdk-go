...
// checks if the EngineLogModified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EngineLogModified{}

// EngineLogModified Engine log modified event.
type EngineLogModified struct {
...
type _EngineLogModified EngineLogModified
...
func NewEngineLogModified(version string, data []BaseEngineLog, webhookId string) *EngineLogModified {
	this := EngineLogModified{}
	this.Version = version
	var eventName string = "engine_log.modified"
...
func (o *EngineLogModified) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *EngineLogModified) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o EngineLogModified) MarshalJSON() ([]byte, error) {
...
func (o EngineLogModified) ToMap() (map[string]interface{}, error) {
...
func (o *EngineLogModified) UnmarshalJSON(data []byte) (err error) {
	...
	varEngineLogModified := _EngineLogModified{}

	err = json.Unmarshal(data, &varEngineLogModified)

	if err != nil {
		return err
	}

	*o = EngineLogModified(varEngineLogModified)
...
type NullableEngineLogModified struct {
	value *EngineLogModified
	isSet bool
}

func (v NullableEngineLogModified) Get() *EngineLogModified {
	return v.value
}

func (v *NullableEngineLogModified) Set(val *EngineLogModified) {
	v.value = val
	v.isSet = true
}

func (v NullableEngineLogModified) IsSet() bool {
	return v.isSet
}

func (v *NullableEngineLogModified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEngineLogModified(val *EngineLogModified) *NullableEngineLogModified {
	return &NullableEngineLogModified{value: val, isSet: true}
}

func (v NullableEngineLogModified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEngineLogModified) UnmarshalJSON(src []byte) error {
	v.isSet = true
