...
// checks if the TrailerModified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrailerModified{}

// TrailerModified Trailer modified event.
type TrailerModified struct {
...
type _TrailerModified TrailerModified
...
func NewTrailerModified(version string, data []BaseTrailer, webhookId string) *TrailerModified {
	this := TrailerModified{}
	this.Version = version
	var eventName string = "trailer.modified"
...
func (o *TrailerModified) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *TrailerModified) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o TrailerModified) MarshalJSON() ([]byte, error) {
...
func (o TrailerModified) ToMap() (map[string]interface{}, error) {
...
func (o *TrailerModified) UnmarshalJSON(data []byte) (err error) {
	...
	varTrailerModified := _TrailerModified{}

	err = json.Unmarshal(data, &varTrailerModified)

	if err != nil {
		return err
	}

	*o = TrailerModified(varTrailerModified)
...
type NullableTrailerModified struct {
	value *TrailerModified
	isSet bool
}

func (v NullableTrailerModified) Get() *TrailerModified {
	return v.value
}

func (v *NullableTrailerModified) Set(val *TrailerModified) {
	v.value = val
	v.isSet = true
}

func (v NullableTrailerModified) IsSet() bool {
	return v.isSet
}

func (v *NullableTrailerModified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrailerModified(val *TrailerModified) *NullableTrailerModified {
	return &NullableTrailerModified{value: val, isSet: true}
}

func (v NullableTrailerModified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrailerModified) UnmarshalJSON(src []byte) error {
	v.isSet = true
