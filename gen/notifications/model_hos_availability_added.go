...
// checks if the HosAvailabilityAdded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HosAvailabilityAdded{}

// HosAvailabilityAdded Hos availability added event.
type HosAvailabilityAdded struct {
...
type _HosAvailabilityAdded HosAvailabilityAdded
...
func NewHosAvailabilityAdded(version string, data []BaseHosAvailability, webhookId string) *HosAvailabilityAdded {
	this := HosAvailabilityAdded{}
	this.Version = version
	var eventName string = "hos_availability.added"
...
func (o *HosAvailabilityAdded) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *HosAvailabilityAdded) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o HosAvailabilityAdded) MarshalJSON() ([]byte, error) {
...
func (o HosAvailabilityAdded) ToMap() (map[string]interface{}, error) {
...
func (o *HosAvailabilityAdded) UnmarshalJSON(data []byte) (err error) {
	...
	varHosAvailabilityAdded := _HosAvailabilityAdded{}

	err = json.Unmarshal(data, &varHosAvailabilityAdded)

	if err != nil {
		return err
	}

	*o = HosAvailabilityAdded(varHosAvailabilityAdded)
...
type NullableHosAvailabilityAdded struct {
	value *HosAvailabilityAdded
	isSet bool
}

func (v NullableHosAvailabilityAdded) Get() *HosAvailabilityAdded {
	return v.value
}

func (v *NullableHosAvailabilityAdded) Set(val *HosAvailabilityAdded) {
	v.value = val
	v.isSet = true
}

func (v NullableHosAvailabilityAdded) IsSet() bool {
	return v.isSet
}

func (v *NullableHosAvailabilityAdded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHosAvailabilityAdded(val *HosAvailabilityAdded) *NullableHosAvailabilityAdded {
	return &NullableHosAvailabilityAdded{value: val, isSet: true}
}

func (v NullableHosAvailabilityAdded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHosAvailabilityAdded) UnmarshalJSON(src []byte) error {
	v.isSet = true
