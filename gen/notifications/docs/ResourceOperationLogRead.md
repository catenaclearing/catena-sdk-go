...
`func (o *ResourceOperationLogRead) SetResponseStatusCodeNil(b bool)`
...
`func (o *ResourceOperationLogRead) SetResponseHeadersNil(b bool)`

 SetResponseHeadersNil sets the value for ResponseHeaders to be an explicit nil

### UnsetResponseHeaders
`func (o *ResourceOperationLogRead) UnsetResponseHeaders()`
