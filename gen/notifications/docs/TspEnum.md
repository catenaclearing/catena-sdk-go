...
* `FLEETCOMPLETEHUB` (value: `"fleetcompletehub"`)

* `FLEETHUNT` (value: `"fleethunt"`)

* `FLEETSHARP` (value: `"fleetsharp"`)
...
* `ONTIME_ELD` (value: `"ontime_eld"`)

* `OPTIMA` (value: `"optima"`)

* `ORBCOMM` (value: `"orbcomm"`)
