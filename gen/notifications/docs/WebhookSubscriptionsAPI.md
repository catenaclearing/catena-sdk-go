...
func main() {
	eventName := openapiclient.WebhookEventName("invitation.created") // WebhookEventName |  (optional)
	status := openapiclient.StatusEnum("active") // StatusEnum |  (optional)
	cursor := "cursor_example" // string | Cursor for the next page (optional)
	size := int32(56) // int32 | Page size (optional) (default to 300)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **eventName** | [**WebhookEventName**](WebhookEventName.md) |  | 
