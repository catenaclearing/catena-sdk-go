...
`func NewBaseUser(id string, fleetId string, fleetRef NullableString, sourceName TspEnum, connectionId string, sourceId string, createdAt time.Time, updatedAt time.Time, occurredAt time.Time, ) *BaseUser`
...
`func (o *BaseUser) GetFleetRef() string`

GetFleetRef returns the FleetRef field if non-nil, zero value otherwise.

### GetFleetRefOk

`func (o *BaseUser) GetFleetRefOk() (*string, bool)`
...
`func (o *BaseUser) SetFleetRefNil(b bool)`

 SetFleetRefNil sets the value for FleetRef to be an explicit nil

### UnsetFleetRef
`func (o *BaseUser) UnsetFleetRef()`
...
`func (o *BaseUser) SetTspIdNil(b bool)`
...
`func (o *BaseUser) SetTspSlugNil(b bool)`
...
`func (o *BaseUser) SetExtrasNil(b bool)`

 SetExtrasNil sets the value for Extras to be an explicit nil

### UnsetExtras
`func (o *BaseUser) UnsetExtras()`
