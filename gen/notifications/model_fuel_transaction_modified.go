...
// checks if the FuelTransactionModified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FuelTransactionModified{}

// FuelTransactionModified Fuel transaction modified event.
type FuelTransactionModified struct {
...
type _FuelTransactionModified FuelTransactionModified
...
func NewFuelTransactionModified(version string, data []BaseFuelTransaction, webhookId string) *FuelTransactionModified {
	this := FuelTransactionModified{}
	this.Version = version
	var eventName string = "fuel_transaction.modified"
...
func (o *FuelTransactionModified) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *FuelTransactionModified) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o FuelTransactionModified) MarshalJSON() ([]byte, error) {
...
func (o FuelTransactionModified) ToMap() (map[string]interface{}, error) {
...
func (o *FuelTransactionModified) UnmarshalJSON(data []byte) (err error) {
	...
	varFuelTransactionModified := _FuelTransactionModified{}

	err = json.Unmarshal(data, &varFuelTransactionModified)

	if err != nil {
		return err
	}

	*o = FuelTransactionModified(varFuelTransactionModified)
...
type NullableFuelTransactionModified struct {
	value *FuelTransactionModified
	isSet bool
}

func (v NullableFuelTransactionModified) Get() *FuelTransactionModified {
	return v.value
}

func (v *NullableFuelTransactionModified) Set(val *FuelTransactionModified) {
	v.value = val
	v.isSet = true
}

func (v NullableFuelTransactionModified) IsSet() bool {
	return v.isSet
}

func (v *NullableFuelTransactionModified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFuelTransactionModified(val *FuelTransactionModified) *NullableFuelTransactionModified {
	return &NullableFuelTransactionModified{value: val, isSet: true}
}

func (v NullableFuelTransactionModified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFuelTransactionModified) UnmarshalJSON(src []byte) error {
	v.isSet = true
