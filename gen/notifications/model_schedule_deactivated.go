...
// checks if the ScheduleDeactivated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleDeactivated{}

// ScheduleDeactivated Schedule deactivated event.
type ScheduleDeactivated struct {
	...
	Data []BaseScheduleEvent `json:"data"`
...
type _ScheduleDeactivated ScheduleDeactivated
...
func NewScheduleDeactivated(version string, data []BaseScheduleEvent, webhookId string) *ScheduleDeactivated {
	this := ScheduleDeactivated{}
	this.Version = version
	var eventName string = "schedule.deactivated"
...
func (o *ScheduleDeactivated) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *ScheduleDeactivated) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o ScheduleDeactivated) MarshalJSON() ([]byte, error) {
...
func (o ScheduleDeactivated) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduleDeactivated) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleDeactivated := _ScheduleDeactivated{}

	err = json.Unmarshal(data, &varScheduleDeactivated)

	if err != nil {
		return err
	}

	*o = ScheduleDeactivated(varScheduleDeactivated)
...
type NullableScheduleDeactivated struct {
	value *ScheduleDeactivated
	isSet bool
}

func (v NullableScheduleDeactivated) Get() *ScheduleDeactivated {
	return v.value
}

func (v *NullableScheduleDeactivated) Set(val *ScheduleDeactivated) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleDeactivated) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleDeactivated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleDeactivated(val *ScheduleDeactivated) *NullableScheduleDeactivated {
	return &NullableScheduleDeactivated{value: val, isSet: true}
}

func (v NullableScheduleDeactivated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleDeactivated) UnmarshalJSON(src []byte) error {
	v.isSet = true
