...
// checks if the DriverVehicleAssociationAdded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DriverVehicleAssociationAdded{}

// DriverVehicleAssociationAdded Driver-vehicle association added event.
type DriverVehicleAssociationAdded struct {
...
type _DriverVehicleAssociationAdded DriverVehicleAssociationAdded
...
func NewDriverVehicleAssociationAdded(version string, data []BaseDriverVehicleAssociation, webhookId string) *DriverVehicleAssociationAdded {
	this := DriverVehicleAssociationAdded{}
	this.Version = version
	var eventName string = "driver_vehicle_association.added"
...
func (o *DriverVehicleAssociationAdded) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *DriverVehicleAssociationAdded) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o DriverVehicleAssociationAdded) MarshalJSON() ([]byte, error) {
...
func (o DriverVehicleAssociationAdded) ToMap() (map[string]interface{}, error) {
...
func (o *DriverVehicleAssociationAdded) UnmarshalJSON(data []byte) (err error) {
	...
	varDriverVehicleAssociationAdded := _DriverVehicleAssociationAdded{}

	err = json.Unmarshal(data, &varDriverVehicleAssociationAdded)

	if err != nil {
		return err
	}

	*o = DriverVehicleAssociationAdded(varDriverVehicleAssociationAdded)
...
type NullableDriverVehicleAssociationAdded struct {
	value *DriverVehicleAssociationAdded
	isSet bool
}

func (v NullableDriverVehicleAssociationAdded) Get() *DriverVehicleAssociationAdded {
	return v.value
}

func (v *NullableDriverVehicleAssociationAdded) Set(val *DriverVehicleAssociationAdded) {
	v.value = val
	v.isSet = true
}

func (v NullableDriverVehicleAssociationAdded) IsSet() bool {
	return v.isSet
}

func (v *NullableDriverVehicleAssociationAdded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDriverVehicleAssociationAdded(val *DriverVehicleAssociationAdded) *NullableDriverVehicleAssociationAdded {
	return &NullableDriverVehicleAssociationAdded{value: val, isSet: true}
}

func (v NullableDriverVehicleAssociationAdded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDriverVehicleAssociationAdded) UnmarshalJSON(src []byte) error {
	v.isSet = true
