...
// checks if the TrailerStatusAdded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrailerStatusAdded{}

// TrailerStatusAdded Trailer status added event.
type TrailerStatusAdded struct {
...
type _TrailerStatusAdded TrailerStatusAdded
...
func NewTrailerStatusAdded(version string, data []BaseTrailerStatus, webhookId string) *TrailerStatusAdded {
	this := TrailerStatusAdded{}
	this.Version = version
	var eventName string = "trailer_status.added"
...
func (o *TrailerStatusAdded) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *TrailerStatusAdded) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o TrailerStatusAdded) MarshalJSON() ([]byte, error) {
...
func (o TrailerStatusAdded) ToMap() (map[string]interface{}, error) {
...
func (o *TrailerStatusAdded) UnmarshalJSON(data []byte) (err error) {
	...
	varTrailerStatusAdded := _TrailerStatusAdded{}

	err = json.Unmarshal(data, &varTrailerStatusAdded)

	if err != nil {
		return err
	}

	*o = TrailerStatusAdded(varTrailerStatusAdded)
...
type NullableTrailerStatusAdded struct {
	value *TrailerStatusAdded
	isSet bool
}

func (v NullableTrailerStatusAdded) Get() *TrailerStatusAdded {
	return v.value
}

func (v *NullableTrailerStatusAdded) Set(val *TrailerStatusAdded) {
	v.value = val
	v.isSet = true
}

func (v NullableTrailerStatusAdded) IsSet() bool {
	return v.isSet
}

func (v *NullableTrailerStatusAdded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrailerStatusAdded(val *TrailerStatusAdded) *NullableTrailerStatusAdded {
	return &NullableTrailerStatusAdded{value: val, isSet: true}
}

func (v NullableTrailerStatusAdded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrailerStatusAdded) UnmarshalJSON(src []byte) error {
	v.isSet = true
