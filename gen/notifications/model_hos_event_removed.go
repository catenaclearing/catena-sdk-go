...
// checks if the HosEventRemoved type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HosEventRemoved{}

// HosEventRemoved Hos event removed event.
type HosEventRemoved struct {
...
type _HosEventRemoved HosEventRemoved
...
func NewHosEventRemoved(version string, data []BaseTelematicsEvent, webhookId string) *HosEventRemoved {
	this := HosEventRemoved{}
	this.Version = version
	var eventName string = "hos_event.removed"
...
func (o *HosEventRemoved) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *HosEventRemoved) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o HosEventRemoved) MarshalJSON() ([]byte, error) {
...
func (o HosEventRemoved) ToMap() (map[string]interface{}, error) {
...
func (o *HosEventRemoved) UnmarshalJSON(data []byte) (err error) {
	...
	varHosEventRemoved := _HosEventRemoved{}

	err = json.Unmarshal(data, &varHosEventRemoved)

	if err != nil {
		return err
	}

	*o = HosEventRemoved(varHosEventRemoved)
...
type NullableHosEventRemoved struct {
	value *HosEventRemoved
	isSet bool
}

func (v NullableHosEventRemoved) Get() *HosEventRemoved {
	return v.value
}

func (v *NullableHosEventRemoved) Set(val *HosEventRemoved) {
	v.value = val
	v.isSet = true
}

func (v NullableHosEventRemoved) IsSet() bool {
	return v.isSet
}

func (v *NullableHosEventRemoved) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHosEventRemoved(val *HosEventRemoved) *NullableHosEventRemoved {
	return &NullableHosEventRemoved{value: val, isSet: true}
}

func (v NullableHosEventRemoved) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHosEventRemoved) UnmarshalJSON(src []byte) error {
	v.isSet = true
