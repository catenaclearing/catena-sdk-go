...
// checks if the ResourceOperationSucceeded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceOperationSucceeded{}

// ResourceOperationSucceeded Resource operation succeeded event.
type ResourceOperationSucceeded struct {
...
type _ResourceOperationSucceeded ResourceOperationSucceeded
...
func NewResourceOperationSucceeded(version string, data []BaseResourceOperationEvent, webhookId string) *ResourceOperationSucceeded {
	this := ResourceOperationSucceeded{}
	this.Version = version
	var eventName string = "resource_operation.succeeded"
...
func (o *ResourceOperationSucceeded) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *ResourceOperationSucceeded) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o ResourceOperationSucceeded) MarshalJSON() ([]byte, error) {
...
func (o ResourceOperationSucceeded) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceOperationSucceeded) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceOperationSucceeded := _ResourceOperationSucceeded{}

	err = json.Unmarshal(data, &varResourceOperationSucceeded)

	if err != nil {
		return err
	}

	*o = ResourceOperationSucceeded(varResourceOperationSucceeded)
...
type NullableResourceOperationSucceeded struct {
	value *ResourceOperationSucceeded
	isSet bool
}

func (v NullableResourceOperationSucceeded) Get() *ResourceOperationSucceeded {
	return v.value
}

func (v *NullableResourceOperationSucceeded) Set(val *ResourceOperationSucceeded) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceOperationSucceeded) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceOperationSucceeded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceOperationSucceeded(val *ResourceOperationSucceeded) *NullableResourceOperationSucceeded {
	return &NullableResourceOperationSucceeded{value: val, isSet: true}
}

func (v NullableResourceOperationSucceeded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceOperationSucceeded) UnmarshalJSON(src []byte) error {
	v.isSet = true
