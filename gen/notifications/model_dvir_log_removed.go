...
// checks if the DvirLogRemoved type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DvirLogRemoved{}

// DvirLogRemoved DVIR log removed event.
type DvirLogRemoved struct {
...
type _DvirLogRemoved DvirLogRemoved
...
func NewDvirLogRemoved(version string, data []BaseTelematicsEvent, webhookId string) *DvirLogRemoved {
	...
	var eventName string = "dvir_log.removed"
...
func (o *DvirLogRemoved) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *DvirLogRemoved) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o DvirLogRemoved) MarshalJSON() ([]byte, error) {
...
func (o DvirLogRemoved) ToMap() (map[string]interface{}, error) {
...
func (o *DvirLogRemoved) UnmarshalJSON(data []byte) (err error) {
	...
	varDvirLogRemoved := _DvirLogRemoved{}

	err = json.Unmarshal(data, &varDvirLogRemoved)

	if err != nil {
		return err
	}

	*o = DvirLogRemoved(varDvirLogRemoved)
...
type NullableDvirLogRemoved struct {
	value *DvirLogRemoved
	isSet bool
}

func (v NullableDvirLogRemoved) Get() *DvirLogRemoved {
	return v.value
}

func (v *NullableDvirLogRemoved) Set(val *DvirLogRemoved) {
	v.value = val
	v.isSet = true
}

func (v NullableDvirLogRemoved) IsSet() bool {
	return v.isSet
}

func (v *NullableDvirLogRemoved) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDvirLogRemoved(val *DvirLogRemoved) *NullableDvirLogRemoved {
	return &NullableDvirLogRemoved{value: val, isSet: true}
}

func (v NullableDvirLogRemoved) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDvirLogRemoved) UnmarshalJSON(src []byte) error {
	v.isSet = true
