...
// checks if the HosEventAdded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HosEventAdded{}

// HosEventAdded Hos event added event.
type HosEventAdded struct {
...
type _HosEventAdded HosEventAdded
...
func NewHosEventAdded(version string, data []BaseHosEvent, webhookId string) *HosEventAdded {
	...
	var eventName string = "hos_event.added"
...
func (o *HosEventAdded) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o HosEventAdded) MarshalJSON() ([]byte, error) {
...
func (o HosEventAdded) ToMap() (map[string]interface{}, error) {
...
func (o *HosEventAdded) UnmarshalJSON(data []byte) (err error) {
	...
	varHosEventAdded := _HosEventAdded{}

	err = json.Unmarshal(data, &varHosEventAdded)

	if err != nil {
		return err
	}

	*o = HosEventAdded(varHosEventAdded)
...
type NullableHosEventAdded struct {
	value *HosEventAdded
	isSet bool
}

func (v NullableHosEventAdded) Get() *HosEventAdded {
	return v.value
}

func (v *NullableHosEventAdded) Set(val *HosEventAdded) {
	v.value = val
	v.isSet = true
}

func (v NullableHosEventAdded) IsSet() bool {
	return v.isSet
}

func (v *NullableHosEventAdded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHosEventAdded(val *HosEventAdded) *NullableHosEventAdded {
	return &NullableHosEventAdded{value: val, isSet: true}
}

func (v NullableHosEventAdded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHosEventAdded) UnmarshalJSON(src []byte) error {
	v.isSet = true
