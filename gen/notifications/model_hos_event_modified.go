...
// checks if the HosEventModified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HosEventModified{}

// HosEventModified Hos event modified event.
type HosEventModified struct {
...
type _HosEventModified HosEventModified
...
func NewHosEventModified(version string, data []BaseHosEvent, webhookId string) *HosEventModified {
	this := HosEventModified{}
	this.Version = version
	var eventName string = "hos_event.modified"
...
func (o *HosEventModified) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *HosEventModified) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o HosEventModified) MarshalJSON() ([]byte, error) {
...
func (o HosEventModified) ToMap() (map[string]interface{}, error) {
...
func (o *HosEventModified) UnmarshalJSON(data []byte) (err error) {
	...
	varHosEventModified := _HosEventModified{}

	err = json.Unmarshal(data, &varHosEventModified)

	if err != nil {
		return err
	}

	*o = HosEventModified(varHosEventModified)
...
type NullableHosEventModified struct {
	value *HosEventModified
	isSet bool
}

func (v NullableHosEventModified) Get() *HosEventModified {
	return v.value
}

func (v *NullableHosEventModified) Set(val *HosEventModified) {
	v.value = val
	v.isSet = true
}

func (v NullableHosEventModified) IsSet() bool {
	return v.isSet
}

func (v *NullableHosEventModified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHosEventModified(val *HosEventModified) *NullableHosEventModified {
	return &NullableHosEventModified{value: val, isSet: true}
}

func (v NullableHosEventModified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHosEventModified) UnmarshalJSON(src []byte) error {
	v.isSet = true
