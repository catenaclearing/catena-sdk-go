...
// checks if the TrailerVehicleAssociationModified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrailerVehicleAssociationModified{}

// TrailerVehicleAssociationModified Trailer-vehicle association modified event.
type TrailerVehicleAssociationModified struct {
...
type _TrailerVehicleAssociationModified TrailerVehicleAssociationModified
...
func NewTrailerVehicleAssociationModified(version string, data []BaseTrailerVehicleAssociation, webhookId string) *TrailerVehicleAssociationModified {
	this := TrailerVehicleAssociationModified{}
	this.Version = version
	var eventName string = "trailer_vehicle_association.modified"
...
func (o *TrailerVehicleAssociationModified) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *TrailerVehicleAssociationModified) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o TrailerVehicleAssociationModified) MarshalJSON() ([]byte, error) {
...
func (o TrailerVehicleAssociationModified) ToMap() (map[string]interface{}, error) {
...
func (o *TrailerVehicleAssociationModified) UnmarshalJSON(data []byte) (err error) {
	...
	varTrailerVehicleAssociationModified := _TrailerVehicleAssociationModified{}

	err = json.Unmarshal(data, &varTrailerVehicleAssociationModified)

	if err != nil {
		return err
	}

	*o = TrailerVehicleAssociationModified(varTrailerVehicleAssociationModified)
...
type NullableTrailerVehicleAssociationModified struct {
	value *TrailerVehicleAssociationModified
	isSet bool
}

func (v NullableTrailerVehicleAssociationModified) Get() *TrailerVehicleAssociationModified {
	return v.value
}

func (v *NullableTrailerVehicleAssociationModified) Set(val *TrailerVehicleAssociationModified) {
	v.value = val
	v.isSet = true
}

func (v NullableTrailerVehicleAssociationModified) IsSet() bool {
	return v.isSet
}

func (v *NullableTrailerVehicleAssociationModified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrailerVehicleAssociationModified(val *TrailerVehicleAssociationModified) *NullableTrailerVehicleAssociationModified {
	return &NullableTrailerVehicleAssociationModified{value: val, isSet: true}
}

func (v NullableTrailerVehicleAssociationModified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrailerVehicleAssociationModified) UnmarshalJSON(src []byte) error {
	v.isSet = true
