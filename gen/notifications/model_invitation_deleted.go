...
// checks if the InvitationDeleted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvitationDeleted{}

// InvitationDeleted Invitation deleted event.
...
type _InvitationDeleted InvitationDeleted
...
func NewInvitationDeleted(version string, data []BaseInvitationEvent, webhookId string) *InvitationDeleted {
	this := InvitationDeleted{}
	this.Version = version
	var eventName string = "invitation.deleted"
...
func (o *InvitationDeleted) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *InvitationDeleted) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o InvitationDeleted) MarshalJSON() ([]byte, error) {
...
func (o InvitationDeleted) ToMap() (map[string]interface{}, error) {
...
func (o *InvitationDeleted) UnmarshalJSON(data []byte) (err error) {
	...
	varInvitationDeleted := _InvitationDeleted{}

	err = json.Unmarshal(data, &varInvitationDeleted)

	if err != nil {
		return err
	}

	*o = InvitationDeleted(varInvitationDeleted)
...
type NullableInvitationDeleted struct {
	value *InvitationDeleted
	isSet bool
}

func (v NullableInvitationDeleted) Get() *InvitationDeleted {
	return v.value
}

func (v *NullableInvitationDeleted) Set(val *InvitationDeleted) {
	v.value = val
	v.isSet = true
}

func (v NullableInvitationDeleted) IsSet() bool {
	return v.isSet
}

func (v *NullableInvitationDeleted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvitationDeleted(val *InvitationDeleted) *NullableInvitationDeleted {
	return &NullableInvitationDeleted{value: val, isSet: true}
}

func (v NullableInvitationDeleted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvitationDeleted) UnmarshalJSON(src []byte) error {
	v.isSet = true
