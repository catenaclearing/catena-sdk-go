...
// checks if the InvitationDeclined type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvitationDeclined{}

// InvitationDeclined Invitation declined event.
...
type _InvitationDeclined InvitationDeclined
...
func NewInvitationDeclined(version string, data []BaseInvitationEvent, webhookId string) *InvitationDeclined {
	...
	var eventName string = "invitation.declined"
...
func (o *InvitationDeclined) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *InvitationDeclined) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o InvitationDeclined) MarshalJSON() ([]byte, error) {
...
func (o InvitationDeclined) ToMap() (map[string]interface{}, error) {
...
func (o *InvitationDeclined) UnmarshalJSON(data []byte) (err error) {
	...
	varInvitationDeclined := _InvitationDeclined{}

	err = json.Unmarshal(data, &varInvitationDeclined)

	if err != nil {
		return err
	}

	*o = InvitationDeclined(varInvitationDeclined)
...
type NullableInvitationDeclined struct {
	value *InvitationDeclined
	isSet bool
}

func (v NullableInvitationDeclined) Get() *InvitationDeclined {
	return v.value
}

func (v *NullableInvitationDeclined) Set(val *InvitationDeclined) {
	v.value = val
	v.isSet = true
}

func (v NullableInvitationDeclined) IsSet() bool {
	return v.isSet
}

func (v *NullableInvitationDeclined) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvitationDeclined(val *InvitationDeclined) *NullableInvitationDeclined {
	return &NullableInvitationDeclined{value: val, isSet: true}
}

func (v NullableInvitationDeclined) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvitationDeclined) UnmarshalJSON(src []byte) error {
	v.isSet = true
