...
// checks if the HosAvailabilityRemoved type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HosAvailabilityRemoved{}

// HosAvailabilityRemoved Hos availability removed event.
type HosAvailabilityRemoved struct {
...
type _HosAvailabilityRemoved HosAvailabilityRemoved
...
func NewHosAvailabilityRemoved(version string, data []BaseTelematicsEvent, webhookId string) *HosAvailabilityRemoved {
	this := HosAvailabilityRemoved{}
	this.Version = version
	var eventName string = "hos_availability.removed"
...
func (o *HosAvailabilityRemoved) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *HosAvailabilityRemoved) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o HosAvailabilityRemoved) MarshalJSON() ([]byte, error) {
...
func (o HosAvailabilityRemoved) ToMap() (map[string]interface{}, error) {
...
func (o *HosAvailabilityRemoved) UnmarshalJSON(data []byte) (err error) {
	...
	varHosAvailabilityRemoved := _HosAvailabilityRemoved{}

	err = json.Unmarshal(data, &varHosAvailabilityRemoved)

	if err != nil {
		return err
	}

	*o = HosAvailabilityRemoved(varHosAvailabilityRemoved)
...
type NullableHosAvailabilityRemoved struct {
	value *HosAvailabilityRemoved
	isSet bool
}

func (v NullableHosAvailabilityRemoved) Get() *HosAvailabilityRemoved {
	return v.value
}

func (v *NullableHosAvailabilityRemoved) Set(val *HosAvailabilityRemoved) {
	v.value = val
	v.isSet = true
}

func (v NullableHosAvailabilityRemoved) IsSet() bool {
	return v.isSet
}

func (v *NullableHosAvailabilityRemoved) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHosAvailabilityRemoved(val *HosAvailabilityRemoved) *NullableHosAvailabilityRemoved {
	return &NullableHosAvailabilityRemoved{value: val, isSet: true}
}

func (v NullableHosAvailabilityRemoved) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHosAvailabilityRemoved) UnmarshalJSON(src []byte) error {
	v.isSet = true
