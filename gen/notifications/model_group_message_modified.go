...
// checks if the GroupMessageModified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupMessageModified{}

// GroupMessageModified Group message modified event.
type GroupMessageModified struct {
...
type _GroupMessageModified GroupMessageModified
...
func NewGroupMessageModified(version string, data []BaseGroupMessage, webhookId string) *GroupMessageModified {
	this := GroupMessageModified{}
	this.Version = version
	var eventName string = "group_message.modified"
...
func (o *GroupMessageModified) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *GroupMessageModified) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o GroupMessageModified) MarshalJSON() ([]byte, error) {
...
func (o GroupMessageModified) ToMap() (map[string]interface{}, error) {
...
func (o *GroupMessageModified) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupMessageModified := _GroupMessageModified{}

	err = json.Unmarshal(data, &varGroupMessageModified)

	if err != nil {
		return err
	}

	*o = GroupMessageModified(varGroupMessageModified)
...
type NullableGroupMessageModified struct {
	value *GroupMessageModified
	isSet bool
}

func (v NullableGroupMessageModified) Get() *GroupMessageModified {
	return v.value
}

func (v *NullableGroupMessageModified) Set(val *GroupMessageModified) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupMessageModified) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupMessageModified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupMessageModified(val *GroupMessageModified) *NullableGroupMessageModified {
	return &NullableGroupMessageModified{value: val, isSet: true}
}

func (v NullableGroupMessageModified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupMessageModified) UnmarshalJSON(src []byte) error {
	v.isSet = true
