...
// checks if the MessageModified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MessageModified{}

// MessageModified Message modified event.
type MessageModified struct {
...
type _MessageModified MessageModified
...
func NewMessageModified(version string, data []BaseMessage, webhookId string) *MessageModified {
	this := MessageModified{}
	this.Version = version
	var eventName string = "message.modified"
...
func (o *MessageModified) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *MessageModified) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o MessageModified) MarshalJSON() ([]byte, error) {
...
func (o MessageModified) ToMap() (map[string]interface{}, error) {
...
func (o *MessageModified) UnmarshalJSON(data []byte) (err error) {
	...
	varMessageModified := _MessageModified{}

	err = json.Unmarshal(data, &varMessageModified)

	if err != nil {
		return err
	}

	*o = MessageModified(varMessageModified)
...
type NullableMessageModified struct {
	value *MessageModified
	isSet bool
}

func (v NullableMessageModified) Get() *MessageModified {
	return v.value
}

func (v *NullableMessageModified) Set(val *MessageModified) {
	v.value = val
	v.isSet = true
}

func (v NullableMessageModified) IsSet() bool {
	return v.isSet
}

func (v *NullableMessageModified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMessageModified(val *MessageModified) *NullableMessageModified {
	return &NullableMessageModified{value: val, isSet: true}
}

func (v NullableMessageModified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMessageModified) UnmarshalJSON(src []byte) error {
	v.isSet = true
