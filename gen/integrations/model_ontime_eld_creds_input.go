...
// checks if the OntimeEldCredsInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OntimeEldCredsInput{}
...
// NewOntimeEldCredsInput instantiates a new OntimeEldCredsInput object
...
// NewOntimeEldCredsInputWithDefaults instantiates a new OntimeEldCredsInput object
...
type NullableOntimeEldCredsInput struct {
	value *OntimeEldCredsInput
	isSet bool
}

func (v NullableOntimeEldCredsInput) Get() *OntimeEldCredsInput {
	return v.value
}

func (v *NullableOntimeEldCredsInput) Set(val *OntimeEldCredsInput) {
	v.value = val
	v.isSet = true
}

func (v NullableOntimeEldCredsInput) IsSet() bool {
	return v.isSet
}
...
func NewNullableOntimeEldCredsInput(val *OntimeEldCredsInput) *NullableOntimeEldCredsInput {
	return &NullableOntimeEldCredsInput{value: val, isSet: true}
}
